...
void* file_dialog_create(bool noKnownDirectoriesSection, bool noCreateDirectorySection, bool noFilteringSection, bool detectKnownDirectoriesAtEachOpening, bool addDisplayByOption, bool dontFilterSaveFilePathsEnteredByTheUser) {
	Internal* internal = (Internal*)ImGui::MemAlloc(sizeof(Internal));
...
void Dialog::init(bool noKnownDirectoriesSection, bool noCreateDirectorySection, bool noFilteringSection, bool detectKnownDirectoriesAtEachOpening, bool addDisplayByOption, bool dontFilterSaveFilePathsEnteredByTheUser) {
	internal = (Internal*)ImGui::MemAlloc(sizeof(Internal));
	new(internal) Internal();
...
#       endif //DEBUG_HISTORY
    ...
    else ImGui::Begin(I.wndTitle, &I.open);
    ImGui::Separator();
...
#           endif //SIMULATING_ONLY
    ...
    if (isSaveFileDialog || isSelectFolderDialog)   {
        ...
        ImGui::PushID(&id);
        if (isSaveFileDialog)   {
			ImGui::AlignTextToFramePadding();// chib AlignFirstTextHeightToWidgets();
